...
int exercicio8()
{
	...
	GLfloat vertices[] = {
		...
		//CEU
		-1.0, 1.0, 0.0, 0.25, 0.25, 1.0, 
		-1.0, 0.0, 0.0, 0.25, 0.25, 1.0,  
		1.0, 1.0, 0.0, 0.25, 0.25, 1.0, 
		-1.0, 0.0, 0.0, 0.25, 0.25, 1.0, 
		1.0, 0.0, 0.0, 0.25, 0.25, 1.0,  
		1.0, 1.0, 0.0, 0.25, 0.25, 1.0, 
		...
		//parte cima casa
		-0.4, 0.6, 0.0, 1.0, 0.5, 0.2,
		0.2, 0.6, 0.0, 1.0, 0.5, 0.2,
		-0.1, 0.9, 0.0, 1.0, 0.5, 0.2,

		//Casa
		-0.4, 0.6, 0.0, 0.9, 0.8, 0.7,
		-0.4, -0.1, 0.0, 0.9, 0.8, 0.7,
		0.2, 0.6, 0.0, 0.9, 0.8, 0.7,
		-0.4, -0.1, 0.0, 0.9, 0.8, 0.7,
		0.2, -0.1, 0.0, 0.9, 0.8, 0.7,
		0.2, 0.6, 0.0, 0.9, 0.8, 0.7,

		//Porta
		-0.2, 0.2, 0.0, 0.4, 0.2, 0.1,
		-0.2, -0.1, 0.0, 0.4, 0.2, 0.1,
		-0.1, 0.2, 0.0, 0.4, 0.2, 0.1,
		-0.2, -0.1, 0.0, 0.4, 0.2, 0.1,
		-0.1, -0.1, 0.0, 0.4, 0.2, 0.1,	
		-0.1, 0.2, 0.0, 0.4, 0.2, 0.1,

		//Janela
		-0.3, 0.4, 0.0, 0.5, 0.5, 1.0,
		-0.3, 0.3, 0.0, 0.5, 0.5, 1.0,
		-0.2, 0.4, 0.0, 0.5, 0.5, 1.0,
		-0.3, 0.3, 0.0, 0.5, 0.5, 1.0,
		-0.2, 0.3, 0.0, 0.5, 0.5, 1.0,
		-0.2, 0.4, 0.0, 0.5, 0.5, 1.0	
