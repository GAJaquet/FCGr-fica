...
int setupShader();
int setupGeometry();
int createCircle(int nPoints, float radius = 0);
...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Ola Espiral! -- Gabriel", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glDrawArrays(GL_LINE_STRIP, 1, nVertices-2);
